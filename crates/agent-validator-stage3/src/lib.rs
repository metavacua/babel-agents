//! Stub crate — `agent-validator-stage3` (chassis design §3/§8). Implementation deferred to a
...
//! `wasm32v1-none`, even though stage3 itself runs the candidate's native
//! build/test — the validator and its target are distinct.
//!
